...
class TSPEnv:
    ...
    def load_problems(self, episode, batch_size, aug_factor=1):
        ...
        if self.mode == 'train':
            ...
            self.problems, self.solutions = self.raw_data_nodes[episode: episode + batch_size], self.raw_data_tours[episode: episode + batch_size]
    ...
    def load_raw_data(self, episode, begin_index=0):  # 100w
