...
MODEL_PATH = "./train_models/tsp50/checkpoint-1010.pt"  # Original pretrained model
...
# MODEL_PATH = "./train_models/tsp100/checkpoint-1010.pt"  # Original pretrained model (tsp100)
